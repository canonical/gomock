...
// Source: go.uber.org/mock/mockgen/internal/tests/exclude (interfaces: GenerateMockForMe)
//
// Generated by this command:
//
//	mockgen -destination=mock.go -package=exclude -exclude_interfaces=IgnoreMe,IgnoreMe2 go.uber.org/mock/mockgen/internal/tests/exclude GenerateMockForMe
//
