...
// Source: go.uber.org/mock/mockgen/internal/tests/import_aliased (interfaces: S)
//
// Generated by this command:
//
//	mockgen -package import_aliased -destination source_mock.go go.uber.org/mock/mockgen/internal/tests/import_aliased S
//
