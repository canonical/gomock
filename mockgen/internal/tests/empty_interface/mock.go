...
// Source: go.uber.org/mock/mockgen/internal/tests/empty_interface (interfaces: Empty)
//
// Generated by this command:
//
//	mockgen -package empty_interface -destination mock.go go.uber.org/mock/mockgen/internal/tests/empty_interface Empty
//
