...
//
//	mockgen -mock_names=Service=PostServiceMock -package mocks -destination mocks/post_service.go -self_package go.uber.org/mock/mockgen/internal/tests/mock_name/mocks go.uber.org/mock/mockgen/internal/tests/mock_name/post Service
//
